declare module "react-native-google-places-native" {
  /**
  ...
  class RNGooglePlacesNative {
    public openAutocompleteModal<K extends keyof GMSTypes.Place>(
      autocompleteFilter: RNGooglePlacesNativeOptions,
      placeFields: K[]
    ...
    public getCurrentPlace<K extends keyof GMSTypes.Place>(
      placeFields: K[]
    ): Promise<Pick<CurrentPlace, typeof placeFields[number] | "likelihood">[]>;
  }
